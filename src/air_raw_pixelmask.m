%profile on
srcfiles = dir('D:\air\27Oct2017_AirScan\1.2.3.2.11.3958\1.2.3.1.11.3958.1\*.dcm');
...
[ResortedData,index] = sort_nat(ResortedDataNew); 
    ...
    %filename = strcat('D:\1.2.3.2.11.3853\New_preprocessed',srcfiles(j).name);
    filename=(("D:\air\27Oct2017_AirScan\1.2.3.2.11.3958\1.2.3.1.11.3958.1\"+char(ResortedData(j))));
...
srcfiles = dir('D:\air\27Oct2017_AirScan\1.2.3.2.11.3958\1.2.3.1.11.3958.2\*.dcm');
for i = 1 : length(srcfiles)
    filename = strcat('D:\air\27Oct2017_AirScan\1.2.3.2.11.3958\1.2.3.1.11.3958.2\',srcfiles(i).name);
...
meistack_s = meistack;
save('D:\air\27Oct2017_AirScan\1.2.3.2.11.3958\1.2.3.1.11.3958.2\avg_ff.mat','meistack_s');
%aux = load('D:\air\27Oct2017_AirScan\1.2.3.2.11.3958\1.2.3.1.11.3958.2\avg_ff.mat');
...
F = single(F);%*44000); %44000 stands for the air value in flatfield corrected images by old versions of mars sw
...
saveastiff(F,'3853.tif');
%figure; imshow(F(:,:,4));title('after point pixel removal')
profile off
profile viewer
