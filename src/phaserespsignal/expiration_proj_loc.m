...
for p =1:s(2) %seperating expiration phase projections
    ...
    switch j
        case 1
            filename_dst =char("C:\UOC\ana worktogetermatlab\rara_10-11\src\PHase selectipn\1\"+char(ResortedData(p)));
        case 2
            filename_dst =char("C:\UOC\ana worktogetermatlab\rara_10-11\src\PHase selectipn\2\"+char(ResortedData(p)));
            % folder
%         case 3
%             filename_dst =char("C:\UOC\ana worktogetermatlab\rara_10-11\src\PHase selectipn\33\"+char(ResortedData(p)));
%         case 4
%             filename_dst =char("C:\UOC\ana worktogetermatlab\rara_10-11\src\PHase selectipn\44\"+char(ResortedData(p)));
%         otherwise
%             filename_dst =char("C:\UOC\ana worktogetermatlab\rara_10-11\src\PHase selectipn\55\"+char(ResortedData(p)));
    end
...
for fdr = 1:2
    switch fdr
        case 1
            ...
            fileID = fopen('C:\UOC\ana worktogetermatlab\rara_10-11\src\PHase selectipn\1\statistics.txt','w');
        case 2
